...
public class TransactionApiController implements TransactionApi {
    ...
    public ResponseEntity<Transaction> transactionGet(@Parameter(in = ParameterIn.QUERY, description = "The number of items to skip before starting to collect the query results" ,schema=@Schema()) @Valid @RequestParam(value = "offset", required = false) Integer offset,@Parameter(in = ParameterIn.QUERY, description = "The numbers of transactions to return" ,schema=@Schema()) @Valid @RequestParam(value = "limit", required = false) Integer limit) {
    ...
    public ResponseEntity<Transaction> transactionPost(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Transaction body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Transaction>(objectMapper.readValue("{\n  \"currencyType\" : \"EUR\",\n  \"dateTimeCreated\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"amount\" : 4800,\n  \"senderUserId\" : 20939,\n  \"senderIBAN\" : \"NL23RABO2298608059\",\n  \"receiverIBAN\" : \"NL67ABNA8265634552\",\n  \"transactionId\" : 2012\n}", Transaction.class), HttpStatus.NOT_IMPLEMENTED);
