...
public interface UsersApi {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "Forbidden, you do not have the required rights") })
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "403", description = "A user with the specified ID was not found."),
